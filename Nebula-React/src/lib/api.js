...
export const getInspirationType = (id) => apiFetch(`/inspiration-types/${id}`)
export const createInspirationType = (data) => apiFetch('/inspiration-types', { method: 'POST', body: JSON.stringify(data) })
export const updateInspirationType = (id, data) => apiFetch(`/inspiration-types/${id}`, { method: 'PATCH', body: JSON.stringify(data) })
export const archiveInspirationType = (id) => apiFetch(`/inspiration-types/${id}`, { method: 'DELETE' })
export const getInspiration = (id) => apiFetch(`/inspirations/${id}`)
